        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-32 animate-reveal">
           <div class="lg:col-span-8">
              <div class="lab-viewport-frame group">
                 ...
                 <div class="absolute top-6 right-6 z-30">
                    <button id="toggle-wireframe-btn" class="px-3 py-1.5 border border-ui-border hover:border-brand-accent hover:text-brand-accent bg-card-bg/90 text-[10px] font-mono transition-all uppercase tracking-wider flex items-center gap-1.5 text-white/90 cursor-crosshair">
                      <span class="w-1.5 h-1.5 rounded-full bg-white/20 transition-all duration-300" id="wireframe-status-dot"></span>
           ...
           <div class="lg:col-span-4 flex flex-col gap-4">
              ...
              ${LAB_MODELS.map(model => `
                <button 
                  class="lab-model-select lab-model-btn group"
                  data-url="${model.url}"
